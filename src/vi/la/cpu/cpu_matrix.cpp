...
matrix::matrix(cpu_context& context, size_t rows, size_t columns, const double* initial_values)
  ...
  if (initial_values) {
    memcpy((void*)values, (const void*)initial_values, value_count * sizeof(double));
  }
  _buffer = values;
}
