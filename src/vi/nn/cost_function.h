...
class cost_function {
public:
  virtual vi::la::matrix cost(const vi::la::matrix& expected,
...
public:
  vi::la::matrix cost(const vi::la::matrix& expected,
                      const vi::la::matrix& actual);
  vi::la::matrix cost_derivative(const vi::la::matrix& expected,
                                 const vi::la::matrix& actual);
};
