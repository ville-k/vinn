...
l2_regularizer::l2_regularizer(double weight_decay) : _weight_decay(weight_decay) {}

std::pair<double, vi::la::matrix> l2_regularizer::penalty(const vi::la::matrix& weights) const {
